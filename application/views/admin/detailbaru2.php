       ...
       <div class="modal fade" id="NewJobModal" tabindex="-1" role="dialog" aria-labelledby="NewJobModalLabel" aria-hidden="true" style="display: none;">
           <div class="modal-dialog" role="document">
               <div class="modal-content">
                   ...
                   <form action="<?php echo base_url() ?>admin/add_data_pelamar" method="post" enctype="multipart/form-data">
                       <div class="modal-body">
                           ...
                           <div class="form-group">
                               <div class="mb-3">
                                   ...
                                   <textarea required class="form-control" id="kompetensi" name="kompetensi" placeholder="contoh : komputer , design grafis , ngelas"></textarea>
                               </div>
