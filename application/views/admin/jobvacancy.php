...
<body id="page-top" class="" style="">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item ">
                <a class="nav-link pb-0" href="<?php echo base_url() ?>admin/list_jobvacancy">
                    <i class="fas fa-fw fa-building"></i>
                    <span>List Job Vacancy</span></a>
                <!-- Nav Item - Dashboard -->
            <li class="nav-item active">
                <a class="nav-link pb-0" href="<?php echo base_url() ?>admin/jobvacancy">
                    <i class="fas fa-fw fa-building"></i>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search 
            <form action="<?= base_url('admin/jobvacancy'); ?>" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                <div class="input-group">
                    <input type="text" class="form-control bg-light border-0 small" placeholder="Cari posisi.." aria-label="Search" aria-describedby="basic-addon2" autofocus name="keyword">
          ...
          <div class="col-md-4 product-grid">
              <div class="image">
                  <a href="', base_url(), 'admin/detail2/' . $row->id, '">
                            ...
                            <form action="<?php echo base_url() ?>admin/add_job" method="post" enctype="multipart/form-data">
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="companyName" name="companyName" placeholder="Company Name">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="jobVacancy" name="jobVacancy" placeholder="Job Vacancy">
                                    </div>
                                    <div class="form-group">
                                        <div class="mb-3">
                                            <label for="validationTextarea">Requirements</label>
                                            <textarea required class="form-control" id="requirement" name="requirement" placeholder="Fill in the blank.."></textarea>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="mb-3">
                                            ...
                                            <textarea required class="form-control" id="special_requirement" name="special_requirement" placeholder="Fill in the blank.."></textarea>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="mb-3">
                                            ...
                                            <textarea required class="form-control" id="note" name="note" placeholder="Fill in the blank.."></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="mb-3">
                                            <label for="validationTextarea">Address</label>
                                            <textarea required class="form-control" id="address" name="address" placeholder="Fill in the blank.."></textarea>
                                        </div>
