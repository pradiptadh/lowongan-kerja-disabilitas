...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- looping menu -->
        ...
        <!-- buat sub-menunya -->
                                    ...
                                    <li class="nav-item ">
                                <a class="nav-link pb-0" href="<?php echo base_url()?>user/job">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow d-sm-none">
                    ...
                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="mr-2 d-none d-lg-inline text-gray-600 small">koplak</span>
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3" style="max-width: 540px;">
                <div class="row no-gutters">
                    <div class="col-md-4">
                        <img src="<?php echo base_url()?>assets/img/profile/default.jpg" class="card-img" alt="...">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title">koplak</h5>
                            <p class="card-text">koplakanda1@gmail.com</p>
                            <p class="card-text"><small class="text-muted">Member since 21 June 2019</small></p>
                        </div>
                    </div>
                </div>
            </div>
