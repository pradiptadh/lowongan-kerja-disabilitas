    ...
    <div class="row">
        ...
        foreach ($job_vacancy->result() as $row) {
          ...
          <div class="col-md-4 product-grid">
              <div class="image">
                  <a href="', base_url(), 'company/detailbaru/' . $row->id, '">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="mb-3">
                            ...
                            <textarea required class="form-control" id="requirement" name="requirement" placeholder="Contoh: Bisa Mengoprasikan Komputer"></textarea>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="mb-3">
                            ...
                            <textarea required class="form-control" id="note" name="note" placeholder="Contoh: Mempunyai pengalaman menjadi nilai khusus"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="mb-3">
